					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							...
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-1.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-2.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-3.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-4.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<div class="desc">
									<h2><a href="#">WWomen's Boots Shoes Maca</a></h2>
									<span class="price">$139.00</span>
									<input type="submit" value="Add to cart" name="addcart">
									<input type="number" name="count" min="1" max="10" value="1">
								</div>
								<input type="hidden" name="img" value="item-5.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-6.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-7.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-8.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-9.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
								<input type="hidden" name="id" value="008">
							</form>
						</div>
					</div>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
								<input type="hidden" name="id" value="009">
							</form>
						</div>
					</div>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-10.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-11.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
								<input type="hidden" name="id" value="011">
							</form>
						</div>
					</div>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-12.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-14.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
								<input type="hidden" name="id" value="013">
							</form>
						</div>
					</div>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
								<input type="hidden" name="id" value="014">
							</form>
						</div>
					</div>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<form action="addcart.php" method="post">
								...
								<input type="hidden" name="img" value="item-15.jpg">
								<input type="hidden" name="name" value="Women's Boots Shoes Maca">
								<input type="hidden" name="price" value="139">
								<input type="hidden" name="id" value="015">
							</form>
						</div>
					</div>
