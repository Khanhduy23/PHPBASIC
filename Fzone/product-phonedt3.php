            ...
            <div class="box-product1">
                ...
                <form action="addcart.php" method="post">
                    <div class="detail-box-product">
                        <div class="box5">
                            <a href=""><img src="assets/img/tainghe3.webp" alt=""></a>
                        </div>
                        <div class="information-sp">
                            <div class="name"><h3>BENGOO G4444</h3></div>
                                <div class="pricedt">
                        ...
                        <p class="sl">
                         ...
                         <input type="hidden" name="img" value="tainghe3.webp">
                         <input type="hidden" name="name" value="BENGOO G4444">
