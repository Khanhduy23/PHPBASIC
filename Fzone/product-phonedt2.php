    ...
    <header>
        <div class="color-header container-header">
            ...
            <div class="logo-section">
                <a href="index.html"><img src="assets/img/Logo2024black.png" alt=""></a>
            </div>
            <!-- Phần Kết Logo -->
        ...
        <div class="container-product">
            ...
            <form action="addcart.php" method="post">
                <div class="detail-box-product">
                    <div class="box5">
                        <a href=""><img src="assets/img/tainghe2.webp" alt=""></a>
                    </div>
                    <div class="information-sp">
                        <div class="name"><h3>BENGOO G9000</h3></div>
                        <div class="pricedt">
                            1.290.000₫<del>2.490.000₫</del>
                        </div>
                        <div class="buy">
                         ...
                         <input type="hidden" name="img" value="tainghe2.webp">
                         <input type="hidden" name="name" value="BENGOO G2000">
                         <input type="hidden" name="price" value="1290000">
